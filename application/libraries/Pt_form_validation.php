...
if (!class_exists('pt_form_validation')) {
    ...
    class Pt_form_validation extends CI_Form_validation {
         ...
         * @example <p>$this->pt_form_validation->set_rules('data_nascimento', 'Data de Nascimento', 'date_br');</p>
         *
         * @param	string data
         * @return	bool 
         */
        ...
        /**
         * <p>Valida CPF</p>
         * @example <p>$this->pt_form_validation->set_rules('cpf', 'CPF', 'cpf');</p>
         *
         * @param	string data
         * @return	bool 
         */
        ...
        /**
         * <p>Valida CNPJ</p>
         * @example <p>$this->pt_form_validation->set_rules('cnpj', 'CNPJ', 'cnpj');</p>
         *
         * @param	string data
         * @return	bool 
         */
         ...
         * @example <p>$this->pt_form_validation->set_rules('login', 'Login', is_unique_custom[usuario.login,id,1]);</p><p>Resultado do Sql: SELECT * FROM `usuario` WHERE `id` != 1 AND `login` = 'administrador' LIMIT 1</p>
         * @example <p>$this->pt_form_validation->set_rules('login', 'Login', is_unique_custom[usuario.login,id,1,true]);</p><p>Resultado do Sql: SELECT * FROM `usuario` WHERE `id` != 1 AND `deletado` = 0 AND `login` = 'administrador' LIMIT 1</p>
         *
         * @param	string data
         ...
         * @example <p>$this->pt_form_validation->set_rules('sexo', 'Sexo', 'opcoes[F,M]');</p>
         * @example <p>$this->pt_form_validation->set_rules('cor', 'Cor', 'opcoes[branco,verde,azul,amarelo,preto,laranja]');</p>
         *
         * @param	string data

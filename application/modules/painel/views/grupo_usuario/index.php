                ...
                <tr>
                    ...
                    <td class="opcoes">
                        ...
                        if (isset($vPainelPermissao['painel/grupo_usuario/remover'])) {
                            ?>
                            <a class="btn btn-danger" href="javascript:;" onclick="confirmacao('Você tem certeza que deseja remover este item?', '<?php echo base_url(); ?>painel/grupo_usuario/remover/<?php echo $oGrupoUsuario->id; ?>');"><i class="icon-trash"></i> <span class="hidden-xs">Excluir</span></a>
                            <?php
                        }
